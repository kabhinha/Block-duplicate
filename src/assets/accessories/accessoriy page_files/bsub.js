...
Line 43:53 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 384:33 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 397:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
var BsubWidget = (function () {
    function BsubWidget() {
        this.attrs = {
            ...
            cartDeliveryPrice: 'data-cart-price',
            cartDeliveryPriceSeperator: 'data-cart-price-seperator',
        ...
        _renderPrices: function (widget) {
            ...
            if (variantId){
                planRadioEls.forEach(function (element) {
                    ...
                    var priceCartBtn = document.querySelector(this.selectors.cartDeliveryPrice);
                    var priceCartBtnSeparator = document.querySelector(this.selectors.cartDeliveryPriceSeperator);

                    var price = sellingPlanAllocation.per_delivery_price;

                    var formattedPrice = this._formatPrice(price);

                    priceCartBtn.innerHTML = '';
                    priceCartBtnSeparator.innerHTML = '';
