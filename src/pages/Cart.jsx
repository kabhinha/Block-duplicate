...
const Cart = () => {
  ...
  const getCartItems = async()=>{
    try{
      const response = await axios.get(`${API_BASE}/cart/items`, {withCredentials:true});
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            ...
            <div className="font-semibold text-xl text-green-800 ">Your Cart</div>
              ...
              <p className="text-xl">
                <span className="text-gray-700 font-semibold text-xl">Total Items: {cartItems.numberOfItems}</span>
              </p>
            </div>
            </div>

            <div className="flex flex-col">
              <p className="text-xl font-bold"><span className="text-gray-700 font-semibold">Total Amount:</span> ${cartItems.totalPrice}</p>
